...
Same modules on managed services: EKS + Karpenter, S3 instead of MinIO (the `minio` workload is
...
monitoring contract. The step contract and the use case do not change. See docs/profiles.md.
