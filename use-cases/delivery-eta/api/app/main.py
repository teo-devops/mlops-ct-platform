"""Delivery Eta API — the synchronous path of the platform for this use case.
...
from app.schemas import DeliveryIn, Lineage, Prediction, Response
...
app = FastAPI(title="Delivery Eta API", version=__version__, lifespan=lifespan)
Instrumentator(
...
@app.post("/v1/deliveries/eta", response_model=Response)
async def predict(features: DeliveryIn, request: Request):
