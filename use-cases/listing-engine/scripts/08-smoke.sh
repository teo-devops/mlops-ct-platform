...
code="$(kubectl -n listing-engine-api exec deploy/listing-engine-api -- python -c "import httpx;print(httpx.get('$url',timeout=5).status_code)" 2>/dev/null)"
