...
The platform was built against a hiring case study of a marketplace: an *Automated Listing Engine*
that, from a listing's photo and title, categorises the product and flags fraud (counterfeits,
suspicious prices). The company and its data are not part of this repository; the problem is generic.
