...
#
#   MODELS="categorizer fraud" TRIGGER=manual PROFILE="" ./use-cases/automated-listing-engine/scripts/07-run-pipeline.sh
...
metadata:
  ...
  labels:
    ...
    ct.mlops/use-case: automated-listing-engine
spec:
  workflowTemplateRef:
    name: ct-pipeline
  arguments:
