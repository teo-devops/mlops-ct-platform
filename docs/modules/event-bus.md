...
| **Where it plugs in** | a platform module `overlays/demo/platform/redpanda`; the API gains a Kafka producer next to `prediction_log.py`; `ctsteps drift` gains a consumer source; shadow deployments read the same topic |
