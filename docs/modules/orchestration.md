...
| **Replace with** | Airflow — the opt-in [airflow](airflow.md) module runs `pipelines/adapters/airflow` on kind; Kubeflow Pipelines (`pipelines/adapters/kfp`, reference) — same containers, different DAG file |
