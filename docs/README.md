...
6. [../use-cases/README.md](../use-cases/README.md) — what a use case is, how one is added, which ones ship; each has its own docs (`use-cases/<name>/docs/`: instance architecture, runbook)
