...
| 2 Scaling & resilience | 2–4 months | drift-driven retraining, dashboards and rules, manual promotion/rollback | **done** (H3); event bus done (Redpanda opt-in, Strimzi documented); next: progressive delivery (Argo Rollouts), autoscaling by QPS, load tests |
...
Near-term backlog, in order: Argo Rollouts module with an
